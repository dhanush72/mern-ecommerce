      ...
      <Page style={styles.body}>
        ...
        <Table data={order.products}>
          <TableBody>
            ...
            />
            <DataTableCell getContent={(content) => content.count} />
        ...
        <Text style={styles.text}>
          <Text>
            Date: {new Date(order.payment.created * 1000).toLocaleString()}{" "}
          </Text>
          <Text>Order Id: {order.payment.id} </Text>
          <Text>Order Status: {order.orderStatus} </Text>
          <Text>Total Paid: {order.payment.amount} </Text>
        </Text>
